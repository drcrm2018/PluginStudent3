    ...
    public sealed class CreateRecordAPI : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
                ...
                context.InputParameters["Target"] is Entity)
            {
                ...
                if (entity.LogicalName != "student3_inquiry")
                    return;
                ...
                try
                {
                    ...
                    using (WebClient client = new WebClient())
                    {
                        ...
                        var data = String.Format("{{\"question\": \"{1}\", \"Response\": \"{1}\", \"id\": \"{0}\", \"Response\": \"{1}\"}}", entity.Id, "student3");
                        client.Headers.Add(HttpRequestHeader.ContentType, "application/json");
                        var response = client.UploadString(new Uri("http://rest.learncode.academy/api/student3/inquiries/"), "POST", data);
                        var apiID = response.Substring(response.IndexOf("id\":\"") + 5, 24);
                        var currentRecord = _service.Retrieve("student3_inquiry", entity.Id, new Microsoft.Xrm.Sdk.Query.ColumnSet(true));
                        currentRecord["student3_name"] = apiID;
                ...
                context.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    ...
                    using (WebClient client = new WebClient())
                    {
                        ...
                        var data = String.Format("{{\"id\": \"{0}\", \"Response\": \"{1}\"}}", apiId, entity.GetAttributeValue<string>("student3_response"));
                        client.Headers.Add(HttpRequestHeader.ContentType, "application/json");
                        var response = client.UploadString(new Uri("http://rest.learncode.academy/api/student3/inquiries/" + apiId), "PUT", data);
